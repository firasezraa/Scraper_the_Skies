...
TWITTER_LOGIN_URL = "https://bsky.app/i/flow/login"
...
class Bsky_Scraper:
    def __init__(
        ...
        print("Initializing Bsky Scraper...")
        self.mail = mail
...
- Twitter is experiencing unusual activity"""
    ...
    def save_to_csv(self):
        ...
        data = {
            ...
            "Repost": [tweet[6] for tweet in self.data],
        ...
        if self.scraper_details["poster_details"]:
            data["Bsky ID"] = [f"user_id:{tweet[15]}" for tweet in self.data]
        ...
        file_path = f"{folder_path}{current_time}_bsky_1-{len(self.data)}.csv"
